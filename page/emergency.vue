...
<template>
	<div class="container">
		<div style="display:none">{{ showLists }}</div>
		<div class="emergency_head">
			<div class="name showPAD" data-txt="急診">24H</div>
			<ul class="tab">
				<li @click="emergency_area('N')" :class="area == 'N' ? 'on' : ''">北部</li>
				<li @click="emergency_area('W')" :class="area == 'W' ? 'on' : ''">中部</li>
				<li @click="emergency_area('S')" :class="area == 'S' ? 'on' : ''">南部</li>
				<li @click="emergency_area('E')" :class="area == 'E' ? 'on' : ''">東部</li>
			</ul>
